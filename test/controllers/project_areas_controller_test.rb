...
class ProjectAreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_area" do
    assert_difference('ProjectArea.count') do
      post project_areas_url, params: { project_area: { investigation_area_id: @project_area.investigation_area_id, project_id: @project_area.project_id } }
    end
  ...
  test "should update project_area" do
    patch project_area_url(@project_area), params: { project_area: { investigation_area_id: @project_area.investigation_area_id, project_id: @project_area.project_id } }
